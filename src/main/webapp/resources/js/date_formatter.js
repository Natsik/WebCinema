...
function formatDate(date, format, utc){
    ...
    var MMM = ["\x01", "Янв", "Фев", "Мар", "Апр", "Мая", "Июня", "Июля", "Авг", "Сен", "Окт", "Нояб", "Дек"];
    var dddd = ["\x03", "Воскресение", "Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота"];
    var ddd = ["\x03", "Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"];
